...
# Beispiel-Aufruf
input_directory = r'D:\Bienenerkennung Ki\Synthetischen Datensatz\SYN_Datensatz_Klein'  # Ordner mit fehlerhaften .txt Dateien
output_directory = r'D:\Bienenerkennung Ki\Synthetischen Datensatz\JPG_DATENSATZ'  # Zielordner für korrigierte .txt Dateien
