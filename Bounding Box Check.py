...
# Beispiel-Aufruf
input_directory = r'D:\Bienen_KI2\PYthon\data\labels2'  # Ordner mit den fehlerhaften .txt Dateien
output_directory = r'D:\Bienen_KI2\PYthon\data\labels' # Zielordner für korrigierte .txt Dateien
